<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tur11.aspx.cs" Inherits="LaPasPrinRomania.Tur11" %>
...
<body>
	...
	<div class="welcome portfolio">
	   <div class="container">
          ...
          <div class="tabs">
	          <div><h2>Descriere</h2><br /><p>Pachet de două zile, cazare, mic dejun, cină, ghid turistic și transport.</p>
				                           <br />
				                           <p><i class="fa fa-eur fa-fw" aria-hidden="true"></i>&nbsp;Preț: 415 RON</p>
				                           ...
				                           <ul style="list-style-type: circle; font-size: 1em; color: #999; line-height: 2em; font-weight: 300;"">
											   <li style="margin-left: 18px;">Grădina Avrig</li>
											   <li style="margin-left: 18px;">Palatul Brukenthal</li>
											   <li style="margin-left: 18px;">Casa Memorială Lucian Blaga</li>
											   <li style="margin-left: 18px;">Giardini di Zoe</li>
											   <li style="margin-left: 18px;">Castelul Huniazilor</li>
											   <li style="margin-left: 18px;">Cetatea Devei</li>
											   <li style="margin-left: 18px;">Biserica Sfântul Nicolae din Densuș</li>
				                           </ul>
				                           <br />
				                           <form runat="server">
		              ...
		              <div class="card center">
			             <div class="info">
				          <h3 class="titlee">Ziua 1</h3>
				           <p class="black">Grădina Avrig --> Palatul Brukenthal --> Casa Memorială Lucian Blaga --> Giardini di Zoe</p>
			             </div>
		              </div>
					  <div class="card center">
			             <div class="info">
				          <h3 class="titlee">Ziua 2</h3>
				           <p class="black">Cetatea Devei --> Castelul Huniazilor --> Biserica Sfântul Nicolae din Densuș</p>
			             </div>
		              </div>
	               </div>
            </div>
            <div><h2>Info ziua 1</h2><br /><p>Prima oprire din program va fi la <b>Gradina Avrig</b> si <b>Palatul Brukenthal</b>. Domeniul de la Avrig cuprinde palatul, parcul – sigurul parc baroc din România de astăzi – și clădirea oranjeriei, în prezent amenajată ca restaurant, sală de evenimente și hotel. În ultimii ani, parcul s-a îmbogățit și cu un imens cort pentru evenimente, o apariție care ne trezește subit din reveriile edenului transilvan la vremurile actuale.</p>
				                           <p>În Sebeș vom vizita <b>Casa Memorială Lucian Blaga</b>, locul în care s-a născut și a copilărit faimosul poet, dramaturg şi filosof român Lucian Blaga. Este o expoziție simplă, dar reușește să redea cât mai fidel urmele unei atmosfere de trecut. Anii se scurg, însă trecerea lor pare a fi derizorie si, cu toate că multe trăiri au fost probabil estompate, aceste câteva frânturi de amintire se vor strădui să rămână veșnic intacte.</p>
				                           <p>După această vizită pornim către <b>Giardini di Zoe</b> – grădinile din Banpotoc. Cu greu vei putea crede că ești în România și nu într-o grădină elegantă din Toscana! În satul Banpotoc, creată parcă să aducă mai aproape un strop din farmecul și peisajele renumite din Toscana.</p>
				                           <p>Cazare la hotel***. Cină inclusă.</p>
            </div>
			<div><h2>Info ziua 2</h2><br /><p>Dimineața, după micul dejun, vizităm <b>Castelul Hunedoarei</b>, numit și Castelul Corvinilor, al Corvineștilor sau al Huniazilor - cetatea medievală a Hunedoarei. Transformat de Iancu de Hunedoara într-un mare castel gotic (în sec. XV) vom putea admira: porțile cetății, turnurile, șantul exterior, capela, Sala Dietei, Palatul Administrativ.</p>
                                           <p>Continuăm, apoi, cu o vizită la <b>Cetatea Devei</b>, una dintre cele mai importante fortificaţii de Evul Mediu din Transilvania și una dintre atracțiile de prim rang din județul Hunedoara. Grație poziționării sale pe dealul care a ajuns să-i poarte numele (Dealul Cetății) fortăreața a fost un punct strategic de apărare pe Valea Mureșului, la granița de astăzi dintre Transilvania și Banat, pe principala arteră de legătură a României cu centrul și vestul Europei.</p>
				                           <p>Ultima vizita este la <b>Biserica Sfântul Nicolae din Densuş</b>, judeţul Hunedoara, una dintre cele mai vechi şi cele mai enigmatice biserici de rit bizantin din România. Se spune despre ea că ar fi cea mai veche biserică din piatră din România, cu slujire neîntreruptă de aproape 2000 de ani. Dacă ajungi în zonă, unii localnici îți vor spune că au auzit din moși strămoși că biserica ar fi fost ridicată de “urieși”, a căror prezență încă este simțită în mentalul colectiv al Țării Hațegului. De altfel, masivul Retezat, însuși, poartă un nume coborât din povești cu giganții de altădată, însă asta e altă istorie, pe care v-o vom spune la vremea potrivită.</p>
            </div>
         </div>
	  </div>
      <div>
         <ul class="minislideshow">
	     <li><span><img src="images/avrig.jpg" style="width: 520px; height: 390px;" /></span></li>
         <li><span><img src="images/blaga.jpg" style="width: 520px; height: 390px;" /></span></li>
	     <li><span><img src="images/giardini.jpg" style="width: 520px; height: 390px;" /></span></li>
	     <li><span><img src="images/deva.jpg" style="width: 520px; height: 390px;" /></span></li>
	     <li><span><img src="images/sfnicolae.jpg" style="width: 520px; height: 390px;" /></span></li>
		 <li><span><img src="images/corvin.jpg" style="width: 520px; height: 390px;" /></span></li>
         </ul>
	  </div>
	  <div class="iframe">
	  <iframe width="520" height="315" src="https://www.youtube.com/embed/BD2aC9Be1HI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style="position: absolute; top: 840px; right: 50px; float: right;" ></iframe>
	  </div>
	  </div>
   </div>
